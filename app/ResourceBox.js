...
import ResourceContainer from './containers/ResourceContainer.js';
...
const ResourceBox = React.createClass({
  ...
  getResources() {
    request
      ...
      .end((err, resp) => {
        if(!err) {
          // When the project is brand new and has no resources, resp.body
          // will be `null`. Default it to an empty array
